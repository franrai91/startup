...
const AppTouchableOpacity = (props) => {
  ...
  switch(props.type){
    case 'primary': return (
      <TouchableOpacity style={[styles.button, styles.primaryButton]} onPress={props.onPress}>
        <Text style={styles.primaryButtonText}>{props.text}</Text>
      </TouchableOpacity>
    );

    case 'secundary': return (
      <TouchableOpacity style={[styles.button, styles.secundaryButton]} onPress={props.onPress}>
